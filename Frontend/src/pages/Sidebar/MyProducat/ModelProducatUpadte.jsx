...
const ModelProducatUpadte = () => {
  ...
  return (
    <>
      <h2 className="text-center text-2xl py-4 text-orange-600">
        Add to Producat
      </h2>
      <form
      ...
      >
        ...
        {spiner ? (
          <button className="w-full bg-orange-600 text-white hover:bg-amber-800 transition-all duration-300 ease-in-out transform py-3 my-2 rounded-md text-center cursor-pointer">
            {' '}
            <FaSpinner className="text-2xl  animate-spin mx-auto" />
          </button>
        ) : (
          <input
            className="w-full bg-orange-600 text-white hover:bg-amber-800 transition-all duration-300 ease-in-out transform py-3 my-2 rounded-md text-center cursor-pointer"
            type="submit"
            value="Add Product"
          />
        )}
